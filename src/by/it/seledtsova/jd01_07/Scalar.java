...
public class Scalar extends Var {  // мы создали двух потомков и он наследуется от класca var
    ...
    Scalar(double value) {  // конструктор будет принемать на вход значение и заносить это значение в приватное поле
        this.value = value;
    }

    Scalar(String strValue) { // конструктор принемает на вход строку и делает из строки число
