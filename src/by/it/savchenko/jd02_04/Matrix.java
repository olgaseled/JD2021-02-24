...
public class Matrix extends by.it.savchenko.jd02_04.Var {
        ...
        if (other instanceof by.it.savchenko.jd02_04.Scalar) {
            ...
            for (int i = 0; i < resMatrix.length; i++) {
                for (int j = 0; j < resMatrix[0].length; j++) {
                    resMatrix[i][j] = resMatrix[i][j] + ((by.it.savchenko.jd02_04.Scalar) other).getValue();
                }
            }
    ...
    public by.it.savchenko.jd02_04.Var mul(by.it.savchenko.jd02_04.Var other) throws CalcException {
        if (other instanceof by.it.savchenko.jd02_04.Scalar) {
            double s = ((by.it.savchenko.jd02_04.Scalar) other).getValue();
            double[][] resMatrix = new double[value.length][0];
            for (int i = 0; i < resMatrix.length; i++) {
                resMatrix[i] = Arrays.copyOf(value[i], value[i].length);
            }
        ...
        if (other instanceof by.it.savchenko.jd02_04.Scalar) {
            ...
            for (int i = 0; i < resultMatrix.length; i++) {
                for (int j = 0; j < resultMatrix[i].length; j++) {
                    resultMatrix[i][j] = resultMatrix[i][j] /= ((by.it.savchenko.jd02_04.Scalar) other).getValue();
                }
            }
