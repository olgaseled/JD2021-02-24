...
public class TaskC3 {
    public static void main(String[] args) {
        ...
        int weightPeople= scanner.nextInt();
        double aMars=getWeight(weightPeople);
        System.out.println(aMars);
    }

    private static double getWeight(int weightPeople) {
    final double mars=3.86;
    final double land=9.81;
    double weight=weightPeople*mars/land;
       double roundOff = (double) Math.round(weight * 100) / 100.00;
       return roundOff;
    }
